...
<li><a class="parent"><i class="fa fa-share-alt fa-fw"></i><span><?php echo $text_menu; ?><span></a>
	 <ul>
      <li><a href="<?php echo $headermenu; ?>"><?php echo $text_headermenu; ?></a></li>
	  </ul>
  </li>
  ...
  <li id="tools"><a class="parent"><i class="fa fa-wrench fa-fw"></i> <span><?php echo $text_tools; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $backup; ?>"><?php echo $text_backup; ?></a></li>
         ...
         <li><a href="<?php echo $backup_pro; ?>">Backup PRO</a></li>
