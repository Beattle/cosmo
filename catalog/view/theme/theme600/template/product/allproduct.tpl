...
<!--        <div class="col-md-2 text-right">
      ...
      <br />
        ...
        <div class="row">
            ...
            <div class="description"><?php echo $cat['cat_desc']?></div>
        </div>
      <div class="row">
   ...
   <!--                           <div class="toggle_cnt">
        ...
        <?php } ?>
            <div class="clear"></div>
            <div class="row see-others">
                <h3><a href="<?php echo $cat['href'] ?>" class="link">Посмотреть все товары <?php echo $cat['name'];?></a></h3>
            </div>
          </div>
        <?php endforeach; ?>
